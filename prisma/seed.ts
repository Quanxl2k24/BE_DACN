...
async function main() {
  ...
  const permissionsData = [
    ...
    { code: 'INTERVIEW_CONDUCT', module: 'ATS', description: 'Được phân công làm người phỏng vấn ứng viên' },
  ...
  const hiringManagerPermissions = ['CV_VIEW', 'CV_DOWNLOAD', 'APPLICATION_STATUS_UPDATE', 'JOB_VIEW', 'INTERVIEW_CONDUCT'];
  ...
  // ==========================================
  // 5. SEED JOB CATEGORIES (Danh mục ngành nghề)
  // ==========================================
  ...
  for (const categoryName of jobCategoriesData) {
  ...
  console.log('✅ Đã seed xong Job Categories (Danh mục ngành nghề).');
